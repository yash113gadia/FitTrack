...
- Use AI-powered food recognition
- Receive personalized nutrition guidance

## Eligibility

You must be at least 13 years old to use the App. If you are under 18, you must have permission from a parent or guardian.

By using the App, you represent and warrant that you:

- Are at least 13 years old
- Have the legal capacity to enter into these Terms
- Will use the App in compliance with these Terms and all applicable laws
...
- Any data loss due to device damage or App uninstallation
...
- Inform your doctor about your nutrition tracking

### Accuracy of Information

While we strive for accuracy, we do not guarantee that:

- Nutritional information from food databases is accurate
- AI-generated recommendations are suitable for your situation
- Calorie and macro calculations are precisely accurate
- The App will meet your specific health needs
...
- The App is a tool to assist, not replace professional guidance
...
The App uses Google Gemini AI for certain features. Your use of these features is also subject to [Google's Terms of Service](https://policies.google.com/terms).

### Food Database

The App accesses Open Food Facts for nutritional data, subject to their [Terms of Use](https://world.openfoodfacts.org/terms-of-use).

### App Stores

Your download and use of the App is also subject to the terms of the Apple App Store or Google Play Store, as applicable.
...
- Any damages related to health decisions made based on App information
...
- Any health-related claims arising from your use of the App
...
We may modify these Terms at any time. Changes become effective when posted in the App. Your continued use after changes constitutes acceptance of the new Terms.
...
We may terminate or suspend your access to the App immediately, without notice, for conduct that we believe:
...
Any disputes not resolved informally shall be resolved through binding arbitration in accordance with the rules of [Arbitration Organization]. The arbitration shall be conducted in [Your City, State/Country].
...
- **Email**: legal@fittrack.app
- **Website**: https://fittrack.app/terms
...
| Topic | Summary |
|-------|---------|
| Medical Advice | App is NOT a substitute for professional medical advice |
| Data Storage | All data stored locally on your device |
| Warranties | App provided "as is" without warranties |
| Liability | Limited liability for damages |
| Disputes | Resolved through arbitration |
| Changes | We may modify Terms at any time |
| Termination | You can stop using anytime by uninstalling |
